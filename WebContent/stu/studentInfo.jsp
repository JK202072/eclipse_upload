...
<body>
  <form method="post" action="/jiuyeGL/studentManage" style="margin:0pt;">
        ...
        <td valign="top" width="500" bgcolor="#f9f9f9" height="350">
         <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td>&nbsp;&nbsp;
              <input name="gender" type="radio" value="男" checked style="border:0;"/>男 &nbsp;
              <input name="gender" type="radio" value="女"  style="border:0;"/>女 &nbsp;
            </td>
          </tr>
          <tr>
          ...
          <tr>
              ...
              <td>&nbsp;&nbsp;
                <input type="text" name="entrancedate" size="width:100px" onfocus="HS_setDate(this)"/>
              </td>
          </tr>
          <tr>

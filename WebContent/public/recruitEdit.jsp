  ...
  <tr>
   ...
   <tr>
    ...
    <tr>
              ...
              <td>&nbsp;&nbsp;
                <input type="text" name="postcode" size="50" value="${recruit.postcode }"/>
              </td>
          </tr>
           <tr>
              <td align="right" height="30">招聘人数：</td>
              <td>&nbsp;&nbsp;
                <input type="text" name="recruitment" size="50" value="${recruit.recruitment }"/>
              </td>
          </tr>
           <tr>
              <td align="right" height="30">工作地点：</td>
              <td>&nbsp;&nbsp;
                <input type="text" name="workingplace" size="50" value="${recruit.workingplace }"/>
              </td>
          </tr>
           <tr>
          ...
          <tr>
              ...
              <td>&nbsp;&nbsp;
                <input type="text" name="edurequire" size="50" value="${recruit.edurequire }"/>
              </td>
          </tr>
          <tr>
              <td align="right" height="30">职位描述及要求：</td>
              <td>&nbsp;&nbsp;
                <input type="text" name="description" size="50" value="${recruit.description }"/>
              </td>
          </tr>
          <tr>
              <td align="right" height="30">使用部门：</td>
              <td>&nbsp;&nbsp;
                <input type="text" name="branch" size="50" value="${recruit.branch }"/>
              </td>
          </tr>
          <tr>
             <td align="right" height="30">联系人：</td>
              <td>&nbsp;&nbsp;
                <input type="text" name="linkman" size="50" value="${recruit.linkman }"/>
              </td>
          </tr>
          <tr>
              <td align="right" height="30">联系电话：</td>
              <td>&nbsp;&nbsp;
                <input type="text" name="telephone" size="50" value="${recruit.telephone }"/>
              </td>
          </tr>
          <tr>
              <td align="right" height="30">单位主页：</td>
              <td>&nbsp;&nbsp;
                <input type="text" name="hostpage" size="50" value="${recruit.hostpage }">
              </td>
          </tr>
           <tr>
              <td align="right" height="30">邮箱：</td>
              <td>&nbsp;&nbsp;
                <input type="text" name="email" size="50" value="${recruit.email }"/>
              </td>
          </tr>
          <tr>
            <td></td>
